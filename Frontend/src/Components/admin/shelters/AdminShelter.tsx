...
type AdminShelterProps = ShelterType & {
  ...
  onViewStaff?: (shelterId: string) => void; // Ensure this is included
};

const AdminShelter: React.FC<AdminShelterProps> = ({ id, name, address, locationCountry, locationCity, onEdit, onDelete, onViewStaff }) => {
  ...
  return(
    <div className="admin-shelter">
      ...
      <div className="admin-shelter-icon" onClick={handleViewStaffClick}>
